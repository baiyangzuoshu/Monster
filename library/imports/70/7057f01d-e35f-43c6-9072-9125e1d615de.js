...
var AISystem = /** @class */ (function (_super) {
    ...
    AISystem.prototype.onBulletUpdate = function (dt, monsterEntity, unitComponent, baseComponent, transformComponent, roleComponent, animateComponent) {
        if (unitComponent.isDead || monsterEntity == null || animateComponent.state != Enum_1.BulletState.Attack) {
            return;
        }
